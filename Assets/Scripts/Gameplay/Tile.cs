...
namespace Assets.Scripts.Gameplay
{
    public class Tile : MonoBehaviour
    {
        ...
        private void FixedUpdate()
        {
            ...
            CheckAndGenerateNextTile();
            CheckAndStartCars();
            CheckAndResetTile();
        }

        public void CheckAndGenerateNextTile()
        {
            if (!Generated)
            {
        ...
        public void GenerateBonus()
        {
            ...
            if (!BonusChanceGenerator.GenerateBonus()) return;
